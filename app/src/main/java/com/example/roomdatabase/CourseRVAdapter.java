...
public class CourseRVAdapter extends ListAdapter<CourseModel, CourseRVAdapter.ViewHolder> {
    ...
    private static final DiffUtil.ItemCallback<CourseModel> DIFF_CALLBACK = new DiffUtil.ItemCallback<CourseModel>() {
        @Override
        public boolean areItemsTheSame(CourseModel oldItem, CourseModel newItem) {
            return oldItem.getId() == newItem.getId();
        }

        @Override
        public boolean areContentsTheSame(CourseModel oldItem, CourseModel newItem) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        CourseModel model = getCourseAt(position);
    ...
    public CourseModel getCourseAt(int position) {
